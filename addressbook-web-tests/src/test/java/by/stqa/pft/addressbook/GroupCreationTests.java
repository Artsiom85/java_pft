...
public class GroupCreationTests {
    ...
    public void GroupCreationTests() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("test07");
        ...
        wd.findElement(By.name("group_header")).sendKeys("test08");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("test09");
